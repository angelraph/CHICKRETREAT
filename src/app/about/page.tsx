...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about LuxeEstates — our story, values, and commitment to excellence in luxury real estate.',
};
...
const milestones = [
  { year: '2008', title: 'Founded in New York', desc: 'LuxeEstates was established by former investment bankers who saw a better way to serve high-net-worth real estate clients.' },
  { year: '2012', title: 'Expanded to LA & Miami', desc: 'Opened offices in Beverly Hills and Brickell, extending our white-glove service to America\'s leading luxury markets.' },
  { year: '2016', title: '$500M Milestone', desc: 'Crossed half a billion in annual transaction volume — cementing our position as a top 10 national luxury brokerage.' },
  { year: '2020', title: 'Digital Transformation', desc: 'Launched our industry-leading digital platform, setting a new standard for virtual property tours and remote closings.' },
  { year: '2023', title: 'Global Network', desc: 'Established referral partnerships with luxury brokerages in 28 countries, giving clients global reach with local expertise.' },
      ...
      <div className="relative pt-24 pb-0 overflow-hidden">
        <div className="relative h-80 sm:h-[480px]">
          <Image
            ...
            alt="LuxeEstates Office"
            fill
            className="object-cover"
            priority
          />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(10,31,68,0.7), rgba(10,31,68,0.9))' }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold font-heading mb-6" style={{ color: '#0A1F44' }}>
                More Than a Transaction — A Transformation
              </h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                LuxeEstates was founded on a simple belief: that the most important financial decision of your life deserves more than a transactional relationship. We built a firm where every client works with a dedicated specialist — not a coordinator, not an assistant, but an expert who owns your outcome personally.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={label} className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                    <p className="text-2xl font-bold font-heading mb-1" style={{ color: '#C9A96E' }}>{value}</p>
                ...
                <div key={m.year} className={`flex items-center gap-6 ${i % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  <div className={`flex-1 ${i % 2 === 0 ? 'text-right' : 'text-left'}`}>
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 inline-block max-w-xs">
                      <p className="font-bold mb-1" style={{ color: '#0A1F44' }}>{m.title}</p>
